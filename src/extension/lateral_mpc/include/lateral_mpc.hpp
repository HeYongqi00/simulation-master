...
struct MpcParameters {
    ...
    double stage_cost_error_yaw;
    double stage_cost_omega;
    double terminal_cost_error_y; 
    double terminal_cost_error_yaw;

    size_t error_y_start;
    size_t error_yaw_start;
    size_t omega_start;
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
         * @brief lateral mpc controller
         * @param pid_control_msg control message
         * @param error_state error state of the car
        */
        void LateralMpcController(PidInterface& pid_control_msg, const ErrorState& error_state);
         ...
         * @param error_state error state of the car
        */
       void LongitudinalPidController(PidInterface& pid_control_msg, const ErrorState& error_state);
        ...
        */
        vector<double> GetSolution(const ErrorState& error_state);
        ...
        */
         ...
         * @return error state
        */
       void ComputePredictions(const CarState& car_state, const vector<double>& control_solutions);
     ...
     * @class FG_eval
     * 
     * @brief construct model of mpc controller
    */
    class FG_eval {
        public:
            /**
